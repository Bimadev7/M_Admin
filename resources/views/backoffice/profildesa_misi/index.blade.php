...
<div class="container">
    ...
    <table class="table">
        ...
        <tbody>
            @foreach ($profildesa_misi as $item)
            <tr>
                <td>
                ...
                {{-- <td class="text-right"> 
                    <a href="{{ route('profildesa_misi.edit', $item->id) }}" class="btn btn-primary">Edit Tentang Desa</a>
                </td> --}}
            </tr>
            @endforeach
        </tbody>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                {{-- <td class="text-right"> 
                    <a href="{{ route('profildesa_misi.edit', $item->id) }}" class="btn btn-primary">Edit Visi</a>
                </td> --}}
            </tr>
            @endforeach
        </tbody>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                {{-- <td class="text-right"> 
                    <a href="{{ route('profildesa_misi.edit', $item->id) }}" class="btn btn-primary">Edit Misi</a>
                </td> --}}
            </tr>
            @endforeach
        </tbody>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                {{-- <td class="text-right"> 
                    <a href="{{ route('profildesa_misi.edit', $item->id) }}" class="btn btn-primary">Edit Sejarah Desa</a>
                </td> --}}
            </tr>
            @endforeach
        </tbody>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <td class="text-right"> {{-- Tombol edit --}}
                    <a href="{{ route('profildesa_misi.edit', $item->id) }}" class="btn btn-primary">Edit Profil Desa</a>
                </td>
            @endforeach
        </tbody>
    </table>
