        ...
        columns: [
            ...
            // Action buttons column
            {
                ...
                render: function (data) {
                    return '<a href="/backoffice/profildesa/' + data + '" class="btn btn-info btn-sm">Show</a>' +
                           '<a href="/backoffice/profildesa/' + data + '/edit" class="btn btn-primary btn-sm mx-1">Edit</a>' +
